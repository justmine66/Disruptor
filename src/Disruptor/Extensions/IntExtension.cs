namespace Disruptor.Extensions
{
    public static class IntExtension
    {
        ...
        /// <summary>
        /// Returns the number of one-bits in the two's complement binary representation of the specified <paramref name="i"/> value. This function is sometimes referred to as the <i>population count</i>.
        /// </summary>
        /// <param name="i"></param>
        /// <returns></returns>
